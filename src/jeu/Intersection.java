...
public class Intersection {
	...
	private Pion pion = null; //une intersection n'as pas de pion au depart
...
@return vrai si l'intersection permet un acces diagonal
*/
...
*/
	...
	public String toString() {
		if (this.pion instanceof Chevre)
			return "C"; // si le pion est de type chevre, on affiche un C
		if (this.pion instanceof Tigre)
			return "T"; //si le pion est de type tigre, on afiche un T
		return "+"; //sinon on affiche un plus representant une intersection libre
	}
}
